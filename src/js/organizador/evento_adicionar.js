...
async function carregarLocais(id_instituicao) {
    ...
    const resposta = await CampusTrack.api.json("../../php/locais/get.php?id_instituicao=" + encodeURIComponent(id_instituicao));
...
async function adicionar_evento(form) {
    const resposta = await CampusTrack.form.enviar(form, "../../php/eventos/adicionar.php");
