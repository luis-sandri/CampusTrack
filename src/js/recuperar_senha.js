document.addEventListener("DOMContentLoaded", function () {
    ...
    formEmail.addEventListener("submit", function (e) {
        ...
        if (emailValor === "") {
            mostrarAlerta("Preencha o e-mail.", "danger");
            return;
        }
    ...
    formNovaSenha.addEventListener("submit", function (e) {
        ...
        var emailValor = inputEmail.value.trim();
        var codigoValor = inputCodigo.value.trim();
        var senhaValor = inputSenhaNova.value.trim();
        ...
        fetch("../php/recuperar_senha_nova.php", {
            method: "POST",
            body: formData
        })
        .then(function (response) {
    ...
    btnVoltar.addEventListener("click", function () {
        ...
        instrucaoTexto.textContent = "Informe seu e-mail cadastrado (Gerente de Blocos ou Organizador) para receber o código de recuperação.";
        esconderAlerta();
    });
});
