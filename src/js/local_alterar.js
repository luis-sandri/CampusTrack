...
async function buscarDados(id) {
    const selectCarregado = await ctCarregarSelect({
    ...
    const resposta = await ctJson("../../php/local_get.php?id=" + encodeURIComponent(id || ""));
...
async function alterar_local(form) {
    ...
    const resposta = await ctEnviarFormulario(form, "../../php/local_alterar.php?id=" + encodeURIComponent(id));
